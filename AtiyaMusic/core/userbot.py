...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("frienddd_zoneee")
            ...
            try:
                await self.one.send_message(
                    config.LOGGER_ID, f"**» {config.BOT_NAME} ᴀssɪsᴛᴀɴᴛ ᴏɴᴇ sᴛᴀʀᴛᴇᴅ :**\n\n✨ ɪᴅ : `{self.one.id}`\n❄ ɴᴀᴍᴇ : {self.one.name}\n💫 ᴜsᴇʀɴᴀᴍᴇ : @{self.one.username}"
                )
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("frienddd_zoneee")
            ...
            try:
                await self.two.send_message(
                    config.LOGGER_ID, f"**» {config.BOT_NAME} ᴀssɪsᴛᴀɴᴛ ᴛᴡᴏ sᴛᴀʀᴛᴇᴅ :**\n\n✨ ɪᴅ : `{self.two.id}`\n❄ ɴᴀᴍᴇ : {self.two.name}\n💫 ᴜsᴇʀɴᴀᴍᴇ : @{self.two.username}"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("frienddd_zoneee")
            ...
            try:
                await self.three.send_message(
                    config.LOGGER_ID, f"**» {config.BOT_NAME} ᴀssɪsᴛᴀɴᴛ ᴛʜʀᴇᴇ sᴛᴀʀᴛᴇᴅ :**\n\n✨ ɪᴅ : `{self.three.id}`\n❄ ɴᴀᴍᴇ : {self.three.name}\n💫 ᴜsᴇʀɴᴀᴍᴇ : @{self.three.username}"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("frienddd_zoneee")
            ...
            try:
                await self.four.send_message(
                    config.LOGGER_ID, f"**» {config.BOT_NAME} ᴀssɪsᴛᴀɴᴛ ғᴏᴜʀ sᴛᴀʀᴛᴇᴅ :**\n\n✨ ɪᴅ : `{self.four.id}`\n❄ ɴᴀᴍᴇ : {self.four.name}\n💫 ᴜsᴇʀɴᴀᴍᴇ : @{self.four.username}"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("frienddd_zoneee")
            ...
            try:
                await self.five.send_message(
                    config.LOGGER_ID, f"**» {config.BOT_NAME} ᴀssɪsᴛᴀɴᴛ ғɪᴠᴇ sᴛᴀʀᴛᴇᴅ :**\n\n✨ ɪᴅ : `{self.five.id}`\n❄ ɴᴀᴍᴇ : {self.five.name}\n💫 ᴜsᴇʀɴᴀᴍᴇ : @{self.five.username}"
                )
            except:
                LOGGER(__name__).error(
